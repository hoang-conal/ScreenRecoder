...
import com.lieshoang.screenrecord.engine.capture.FileSystemException
import com.lieshoang.screenrecord.engine.capture.PrepareFailedException
import com.lieshoang.screenrecord.engine.capture.getRecordingInfo
import com.lieshoang.screenrecord.common.misc.timestampString
...
internal fun RealCaptureEngine.createAndPrepareRecorder(context: Context): Boolean {
  ...
  recorder = MediaRecorder().apply {
    ...
    val outputFile = File(outputFolder, "Recorder-$now.mp4")
