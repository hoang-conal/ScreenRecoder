 ...
 */
package com.lieshoang.screenrecord.engine.service
...
import com.lieshoang.screenrecord.common.intent.IntentReceiver
import com.lieshoang.screenrecord.common.lifecycle.SimpleLifecycle
import com.lieshoang.screenrecord.common.permissions.PermissionChecker
import com.lieshoang.screenrecord.common.prefs.PrefNames.PREF_ALWAYS_SHOW_CONTROLS
import com.lieshoang.screenrecord.common.prefs.PrefNames.PREF_STOP_ON_SCREEN_OFF
import com.lieshoang.screenrecord.common.prefs.PrefNames.PREF_STOP_ON_SHAKE
import com.lieshoang.screenrecord.common.rx.attachLifecycle
import com.lieshoang.screenrecord.engine.capture.CaptureEngine
import com.lieshoang.screenrecord.engine.gesture.ShakeListener
import com.lieshoang.screenrecord.engine.overlay.OverlayManager
import com.lieshoang.screenrecord.engine.permission.OverlayPermissionActivity
import com.lieshoang.screenrecord.engine.permission.StoragePermissionActivity
import com.lieshoang.screenrecord.engine.recordings.Recording
import com.lieshoang.screenrecord.engine.recordings.RecordingManager
import com.lieshoang.screenrecord.engine.recordings.RecordingScanner
import com.lieshoang.screenrecord.notifications.DELETE_ACTION
import com.lieshoang.screenrecord.notifications.EXIT_ACTION
import com.lieshoang.screenrecord.notifications.EXTRA_RECORDING
import com.lieshoang.screenrecord.notifications.EXTRA_STOP_FOREGROUND
import com.lieshoang.screenrecord.notifications.Notifications
import com.lieshoang.screenrecord.notifications.RECORD_ACTION
import com.lieshoang.screenrecord.notifications.STOP_ACTION
...
class BackgroundService : Service(), LifecycleOwner {
  ...
  companion object {
    ...
    const val PERMISSION_DENIED =
      "com.lieshoang.screenrecord.service.PERMISSION_DENIED"
